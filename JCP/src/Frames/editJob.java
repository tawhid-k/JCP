...
public class editJob extends javax.swing.JFrame {
    ...
    public editJob(int init, editJob e) throws ClassNotFoundException, SQLException {
        initComponents();
        EDITJOB = e;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 140, 69));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 443, 100, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            DBconnector db = new DBconnector ();
            String s1 = "delete from company where c_name = '"+l5.getText().substring(3)+"'";
            try {
                db.openConnection();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!l1.getText().equals(""))
        {
            try {
            DBconnector db = new DBconnector ();
            String s1 = "delete from company where c_name = '"+l1.getText().substring(3)+"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            DBconnector db = new DBconnector ();
            String s1 = "delete from company where c_name = '"+l2.getText().substring(3)+"'";
            db.openConnection();
            db.st.executeUpdate (s1);
            db.closeConnection();
            this.setVisible(false);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       if (!l3.getText().equals(""))
       {
        try {
            DBconnector db = new DBconnector ();
            String s1 = "delete from company where c_name = '"+l3.getText().substring(3)+"'";
            db.openConnection();
            db.st.executeUpdate (s1);
            db.closeConnection();
            this.setVisible(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            DBconnector db = new DBconnector ();
            String s1 = "delete from company where c_name = '"+l4.getText().substring(3)+"'";
            db.openConnection();
            db.st.executeUpdate (s1);
            db.closeConnection();
            this.setVisible(false);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            if (initial_id == const_id) {
                ...
                new editJob(initial_id+1, this).setVisible (true);
                this.setVisible(false);
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(editCourse.class.getName()).log(Level.SEVERE, null, ex);
